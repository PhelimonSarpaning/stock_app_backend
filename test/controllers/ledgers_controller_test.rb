...
class LedgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post ledgers_url, params: { ledger: { qty: @ledger.qty, stock_id: @ledger.stock_id, user_id: @ledger.user_id } }, as: :json
    end
  ...
  test "should update ledger" do
    patch ledger_url(@ledger), params: { ledger: { qty: @ledger.qty, stock_id: @ledger.stock_id, user_id: @ledger.user_id } }, as: :json
    assert_response 200
  end
